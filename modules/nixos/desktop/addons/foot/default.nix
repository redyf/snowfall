      ...
      programs.foot = {
        ...
        settings = {
          main = {
            ...
            # font = "CaskaydiaCove Nerd Font:Bold:style=Extra Bold Italic:size=16";
            # font = "BlexMono Nerd Font:Bold:style=Extra Bold Italic:size=16";
            # font = "LiterationMono Nerd Font:Bold:style=Bold Italic:size=16";
            pad = "0x0 center";
          };
          cursor = {
